...
$query_Recordset1 = "SELECT usuarios.NIP, usuarios.tarjeta_n FROM usuarios";
...
if (isset($_POST['tarjeta'])) {
  ...
  $MM_redirectLoginSuccess = "OXXO.php";
...
<form id="form2" name="form2" method="POST" action="<?php echo $loginFormAction; ?>">
  ...
  <a><input type="submit" name="button" id="button" value="Enviar" /></a>
